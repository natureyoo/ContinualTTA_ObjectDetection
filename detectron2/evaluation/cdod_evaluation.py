...
class CrossDomainDetectionEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        self._logger.info(
            "Evaluating {} using VOC2007 metric. "
        ...
        #     self._output_dir, "results", self._dataset_name, res_file_template
        # )
        # if not os.path.exists(os.path.join(self._output_dir, "results", self._dataset_name)):
        #     os.makedirs(os.path.join(self._output_dir, "results", self._dataset_name))
        #
