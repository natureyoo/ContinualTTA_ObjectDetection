...
def adjust_learning_rate(optimizer, cur_iters, total_iters, cfg):
    """Decay the learning rate with half-cycle cosine after warmup"""
    if cur_iters < cfg.SOLVER.WARMUP_ITERS:
        lr = cfg.SOLVER.BASE_LR * cur_iters / cfg.SOLVER.WARMUP_ITERS
    else:
        lr = cfg.SOLVER.MIN_LR + (cfg.SOLVER.BASE_LR - cfg.SOLVER.MIN_LR) * 0.5 * \
            (1. + math.cos(math.pi * (cur_iters - cfg.SOLVER.WARMUP_ITERS) / (total_iters - cfg.SOLVER.WARMUP_ITERS)))
